                ...
                <form action="<?=ADMIN;?>/product/add" method="post" data-toggle="validator" id="add">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for=" ">Выберите основное изображение </label>
                                    
                                    <div class="box-body">
                                        <div id="single" class="btn btn-success" data-url="<?=PATH?>/product/add-image" data-name="single">Выбрать файл</div>
                                        <p><small>Рекомендуемые размеры: 375х375</small></p>
                       ...
                       <div class="form-group"> <br> <br> <br> <br> <br> <br> <br></div>
                        <!-- <div class="form-group has-feedback">
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="status" checked> На главной странице "Выпечка"
                            </label>
                        </div>

                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="hit"> На главной странице "Сладости"
                            </label>
                        </div>
