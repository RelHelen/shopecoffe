...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=PATH;?>" class="logo" target="_blank">
            <!-- <span class="logo-mini"><b>о</b>TW</span> -->
            <span class="logo-lg"><b>Панель</b> 
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            <!-- Sidebar user panel -->
             <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    <a href="#"><i class="fa fa-circle text-success"></i> Менеджер</a>
                </div>
            </div>  
            <!-- search form -->
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-navicon"></i> <span>Категории меню</span>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-cubes"></i> <span>Продукция</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?= ADMIN ?>/product/add">Добавить продукт</a></li>
                    </ul>
                </li>
                <!-- <li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2024 Восточный пекарь </strong>
    </footer>
