                ...
                <div class="sngl-top">
                    <div class="col-md-6 single-top-left">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <li data-thumb="<?=PATH?>/images/<?=$item->img;?>">
                                    <div class="thumb-image"> 
                                        <img src="<?=PATH?>/images/<?=$item->img;?>" data-imagezoom="true" class="img-responsive" alt=""/> 
                                    </div>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                        ...
                        <?php else: ?>
                            <div class="thumb-image-2"> 
                            <img src="<?=PATH?>/images/<?=$product->img;?>" alt="" class="img-responsive">
                            </div>
                        <?php endif; ?>
                        <!-- FlexSlider -->
                    ...
                    <div class="col-md-5 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <div class="d-flex mt-5  justify-content-start align-items-start"> 
                                <div class="quantity">
                                    <input type="number" size="4" value="1" name="quantity" min="1" step="1">
                                </div>
                                <a id="productAdd" data-id="<?=$product->id;?>" href="<?=PATH?>/cart/add?id=<?=$product->id;?>" class="  item_add add-to-cart-link">Добавить в заказ</a>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"> </div>
                ...
                <?php if($related): ?>
                  <div class="latestproducts">
                    <div class="product-one">
                        <h3>С этим товаром выбирают:</h3>
                        <?php foreach($related as $item): ?>
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                <a href="<?=PATH?>/product/<?=$item['alias'];?>" class="mask"><img class="img-responsive zoom-img" src="<?=PATH?>/images/<?=$item['img'];?>" alt="" /></a>
                                <div class="product-bottom">
                                    <h3><a href="<?=PATH?>/product/<?=$item['alias'];?>"><?=$item['title'];?></a></h3>
                                    <!-- <p>Explore Now</p> -->
                                    <h4>
                                    ...
                                    <a class="item_add add-to-cart-link" href="<?=PATH?>/cart/add?id=<?=$item['id'];?>" data-id="<?=$item['id'];?>">
